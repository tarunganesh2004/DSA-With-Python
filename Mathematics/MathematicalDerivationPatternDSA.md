# DSA Notes -  Mathematical Derivation and Search Space Reduction Pattern

# Qsn: — Represent a Number as Sum of Consecutive Natural Numbers
# Problem
...
# Pattern Name (Save in DSA Notebook)
...
Supporting
★★★★☆ Boundary Derivation using Mathematics
```
--------

![pattern](image.png)

Similar Problems Under This Pattern

| Problem                          | Pattern                      |
| -------------------------------- | ---------------------------- |
| Consecutive Numbers Sum (LC 829) | AP + Mathematical Derivation |
| Reach a Number (LC 754)          | Mathematical Derivation      |
| Poor Pigs (LC 458)               | Mathematical Reasoning       |
| Mirror Reflection (LC 858)       | GCD / Math                   |
| Water & Jug Problem (LC 365)     | Number Theory + GCD          |
| Sum of Consecutive Numbers       | AP + Equation Derivation     |

![permanentPattern](image-1.png)